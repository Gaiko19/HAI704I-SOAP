...
public class Reservation {
	...
	public void getRecipe() {
		int size = 31;  
		System.out.println(formRecipe(size, "Client Infos"));
		System.out.println("|                             |");
		System.out.println(adaptiveDisplay("info", client.getFirstname(), size));
		System.out.println(adaptiveDisplay("info", client.getName(), size));
		System.out.println(adaptiveDisplay("info", client.getTelNumber(), size));
		System.out.println("|                             |");
		System.out.println(formRecipe(size, "Reservation Infos"));
		System.out.println("|                             |");
		System.out.println(adaptiveDisplay("hotelName", String.valueOf(room.getRoomNumber()), size));
		System.out.println(adaptiveDisplay("room", String.valueOf(room.getRoomNumber()), size));
		System.out.println(adaptiveDisplay("datein", String.valueOf(in), size));
		System.out.println(adaptiveDisplay("dateout", String.valueOf(out), size));
		System.out.println(adaptiveDisplay("price", String.valueOf(out), size));
		System.out.println(formRecipe(size, "footer"));
	}
	
	private String formRecipe(int size, String element) {
		String display = "";
		String firstLine = "+";
		String middleLine = "|";
		int wSpace = size - 2;
	...
	private String adaptiveDisplay(String choice, String element, int size) {
		int wSpace = 0;
		String startLine = "| ";
