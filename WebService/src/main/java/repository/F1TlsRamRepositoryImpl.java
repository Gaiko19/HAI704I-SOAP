...
public class F1TlsRamRepositoryImpl implements HotelRepository {

	private Hotel hotel = new Hotel();
	
	public F1TlsRamRepositoryImpl() {
		...
		try{  
			...
			ResultSet rs=stmt.executeQuery("select * from Hotel where id=2");
			if(rs.next()) {
